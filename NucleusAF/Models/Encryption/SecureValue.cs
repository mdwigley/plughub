...
namespace NucleusAF.Models.Encryption
{
    /// <summary>
    ...
    /// </summary>
    /// <remarks>
    /// When NucleusAF processes a configuration class it treats any property that is
    ...
    /// <remarks>
    /// <para>
    /// <b>Internal use</b> – <strong>SecureValue</strong> is part of NucleusAF’s plumbing

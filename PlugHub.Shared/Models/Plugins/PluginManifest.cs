...
{
    public class PluginLoadState(Guid pluginId = default, string assemblyName = "Unknown", string className = "Unknown", string interfaceName = "Unknown", bool enabled = false, bool system = false, int loadOrder = int.MaxValue)
    {
